    ...
    <nav class="mt-4 px-2">
        ...
        <div x-data="{ open: false }" class="mt-2">
            ...
            <div x-show="open" x-transition class="mt-2 ml-4 space-y-2">
                ...
                <a href="{{ route('domains.category.domains') }}" class="block px-2 py-1 text-sm text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">Categories</a>
            </div>
        </div>
    </nav>
</aside>
