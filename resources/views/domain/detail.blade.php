                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="text-center">
                            <div class="text-2xl font-bold text-blue-600">{{ count($domains) }}</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">查询域名总数</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-green-600">{{ count($foundDomains) }}</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">找到数据</div>
                        </div>
                        <div class="text-center">
                            <div class="text-2xl font-bold text-red-600">{{ count($notFoundDomains) }}</div>
                            <div class="text-sm text-gray-600 dark:text-gray-400">未找到数据</div>
                        </div>
                    </div>
                </div>
            </div>
