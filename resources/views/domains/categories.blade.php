        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {{-- 分类总数 --}}
                    <div class="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-800 dark:to-blue-900 p-6 rounded-2xl shadow-sm border border-blue-200 dark:border-blue-700">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ $categoriesWithTranslation->count() }}</div>
                            </div>
                        </div>
                    </div>
                    
                    {{-- 已分类域名 --}}
                    <div class="bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-800 dark:to-green-900 p-6 rounded-2xl shadow-sm border border-green-200 dark:border-green-700">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ number_format($categoriesWithTranslation->sum('count')) }}</div>
                            </div>
                        </div>
                    </div>

                    {{-- 平均每分类 --}}
                    <div class="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-gray-800 dark:to-purple-900 p-6 rounded-2xl shadow-sm border border-purple-200 dark:border-purple-700">
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <div class="text-3xl font-bold text-gray-800 dark:text-gray-100">{{ number_format($categoriesWithTranslation->avg('count'), 0) }}</div>
                            </div>
                        </div>
                    </div>
                </div>
